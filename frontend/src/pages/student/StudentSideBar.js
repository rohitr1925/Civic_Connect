        ...
        <>
            <React.Fragment>
                ...
                <ListItemButton component={Link} to="/Student/subjects">
                    ...
                    <ListItemText primary="Polls & Surveys" />
                </ListItemButton>
                ...
                <ListItemButton component={Link} to="/Student/uEvents">
                    <ListItemIcon>
                        <ClassOutlinedIcon color={location.pathname.startsWith("/Student/uEvents") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
                ...
                <ListItemButton component={Link} to="/Student/allSRS">
                    <ListItemIcon>
                        <AnnouncementOutlinedIcon color={location.pathname.startsWith("/Student/allSRS") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
                    <ListItemText primary="AllSRS" />
                </ListItemButton>
            </React.Fragment>
            <Divider sx={{ my: 1 }} />
            <React.Fragment>
